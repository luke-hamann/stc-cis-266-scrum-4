...
<LI><A HREF="Input.jsp?method=13&methodName=createCat" TARGET="inputs">createCat(java.lang.String,java.lang.String,double)</A></LI>
</UL>
<%
if (com.ibm.ccl.ws.jaxws.gstc.util.AsyncUtils.hasAsync(sampleTeam1_Cat_APIPortProxyid.getClass())) {
%>
